...
export class PersonasService {
    public personas: Array<any> = [{ "id": 1, "first_name": "Gary", "last_name": "Ortiz", "email": "gortiz0@mapy.cz", "country": "Indonesia", "modified": "2015-05-16", "vip": false },
    ...
    getPerson(index: number) {
        let encontro = this.personas.findIndex(element => { element.id == index });
        if (encontro == -1) {
